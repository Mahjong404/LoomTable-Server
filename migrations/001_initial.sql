...
CREATE INDEX IF NOT EXISTS bases_workspace_live_idx ON bases (workspace_id, id) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS tables_base_live_idx ON tables (base_id, id) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS fields_table_live_idx ON fields (table_id, position_index, id) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS views_table_live_idx ON views (table_id, id) WHERE deleted_at IS NULL;
