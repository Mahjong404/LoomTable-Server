...
- 依据 Plugin 仓库 `docs/local/ux-gap-2026-09-17/12-server-requirements.md` 的 S1–S8 需求，Server 合同按只加不破演进；以下提交已随 `main` 推送至 `fe19de7`，无关联 PR 或 CI run。
...
- 本节提交在未形成 PR/Release 前不更新“当前基线”与 Stable-support 边界；Plugin 仍以已发布 OpenAPI 与响应合同为准。
